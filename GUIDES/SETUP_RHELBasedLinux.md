...
Before starting up, make sure you have the following packages installed: ``python3 git neofetch ffmpeg flac nano python3-wheel``.
...
Secondly, to install the packages packages, run the following command:
