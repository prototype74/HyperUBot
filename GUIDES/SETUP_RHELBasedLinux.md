# HyperUBot Guide - Set up in a RHEL Based Distro
## 0. Pre-requisites
...
The Setup Assistant guides you through all required processes to run HyperUBot properly on your Red Hat System such as creating the configuration file and installing the pip requirements automatically.
...
### 2.2.5-2 Setup config using py scriptt
