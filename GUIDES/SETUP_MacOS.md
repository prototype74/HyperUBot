...
Having the Homebrew Package Manager installed, all that is remaining to do to finish the pre-requisites is installing the following packages:
...
You can do such by typing in the terminal:
...
The Setup Assistant guides you through all required processes to run HyperUBot properly on macOS such as creating the configuration file and installing the pip requirements automatically.
...
then congratulations! You successfully did setup HyperUBot on macOS!
