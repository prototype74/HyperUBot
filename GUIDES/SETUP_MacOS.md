...
The HyperUBot project has only been tested in macOS Catalina 10.15, so this is the only supported versionyour. When the new Big Sur gets stable, if changes are needed, the guide will be updated.
