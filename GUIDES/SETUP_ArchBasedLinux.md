...
The Setup Assistant guides you through all required processes to run HyperUBot properly on your Arch Linux System such as creating the configuration file or installing the pip requirements automatically.
